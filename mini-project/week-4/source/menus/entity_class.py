from menus.utils import get_limited_digit_input, get_list_of_unique_keys, is_valid_attribute
        ...
        for key in new_item:
            while True:
                ...
                if key=='order_status':
                    ...
                    print("\n")
                    value=get_limited_digit_input(len(self.couriers.original_list), msg)
                    new_item[key]=value
                    break
                    ...
                    while True:
                        value=get_limited_digit_input(len(self.products.original_list), msg)
                        values+=str(value)
